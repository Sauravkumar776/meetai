                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-muted-foreground text-balance">
                                    Sign in to continue to Meet.AI
                                </p>
                            </div>
                            ...
                            {
                                !!error && <Alert variant="destructive" className="bg-destructive/10 text-sm">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <Button disabled={pending} type="button" variant="outline" className="w-full">Google</Button>
                                <Button disabled={pending} type="button" variant="outline" className="w-full">GitHub</Button>
                            </div>
                            <div className="text-center text-sm">
                                <span className="text-muted-foreground">
                                    Don't have an account? <Link href="/sign-up" className="text-blue-700 hover:underline">Sign up</Link>
                                </span>
                            </div>
                        </div>
                    </form>
